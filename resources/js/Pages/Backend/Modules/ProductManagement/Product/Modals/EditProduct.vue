...
function show(product) {
    ...
    modalInstance = Modal.getOrCreateInstance(
        document.getElementById("edit_product_modal")
    );
    modalInstance.show();
}
...
function updateProduct() {
    form.post(`/admin/update-product/${form.id}`, {
        preserveScroll: true,
        onSuccess: () => {
            const modalEl = document.getElementById("edit_product_modal");
